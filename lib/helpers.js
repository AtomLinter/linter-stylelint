...
/* eslint no-underscore-dangle: ["error", { "allow": ["_postcssResult"] }] */
...
export const runStylelint = async (editor, stylelintOptions, filePath, settings) => {
  ...
  if (stylelintOptions.fix) {
    saveCleanedStyles(editor, results);
  }
